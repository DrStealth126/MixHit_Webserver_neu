...
cCocktail::cCocktail(String pCocktailName, int pFuel)
{
	mCocktailName = pCocktailName;
	mFuel = pFuel;
}

cCocktail::cCocktail(String pCocktailName, std::vector<cIngredient> pIngredients, int pFuel)
{
	mCocktailName = pCocktailName;
	mFuel = pFuel;
...
cCocktail * cCocktail::fromJson(String json)
{
	...
	cJSON_ArrayForEach(element, ingArray) {
		...
		String ingName = cJSON_GetObjectItem(element, "Zutat")->valuestring;
