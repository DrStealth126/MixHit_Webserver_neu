...
*/
SingleReservoir::SingleReservoir(int pId, String pName, double pm, double pb, int pSumServed)
{
	id = pId;
	mName = pName;
	mm = pm;
...
String SingleReservoir::getName()
{
	return mName;
}
...
int cReservoir::getReservoirIndex(String pName)
{
	return getReservoirIndex(String(pName.c_str()));
}
